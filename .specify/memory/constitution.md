...
Code MUST be simple, clear, and readable. Complex one-liners MUST be avoided in favor of straightforward, maintainable solutions. Functions MUST have single responsibilities and clear naming. Comments MUST explain "why" not "what". Refactoring MUST prioritize readability over cleverness.
...
### Code Review Process
All pull requests MUST be reviewed by at least one maintainer. Reviews MUST verify compliance with all constitution principles. Performance impact MUST be considered for any changes to routing or provider logic. Breaking changes MUST be justified with migration plans.
...
All PRs and code reviews MUST verify compliance with these principles. Complexity MUST be justified with clear performance or reliability benefits. Use this constitution as the primary guide for architectural decisions.
